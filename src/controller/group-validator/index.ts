...
import {
  ...
  getSolutionsLinked,
  newGroupValidator,
} from "../../repository/repository.group-validator";
...
export default class GroupValidatorController extends Controller {
   ...
   */
  @Post()
  public async newGroupValidator(
    @Body() body: GroupValidatorBody
  ): Promise<any> {
  ...
  @Get("/solution")
  public async getSolutionsLinked(
    @Query() query: any,
    @Inject() groupValidator: GroupValidatorI,
    @Inject() user: UserI
  ...
  public async getBaremosLinkedToSolution(
