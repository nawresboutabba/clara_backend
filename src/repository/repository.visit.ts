 ...
 * @returns 
 */
export const getLatest = async (query: {init: number, offset: number }, user: UserI): Promise<any> => {
  try{
    const lastestVisit = await VisitService.getLastestVisitByUserId(user, query)
